...
| 0004 | Sanitiser/tronquer le champ error de /api/auth/check | bug | P2 | 🔴 todo | |
| 0006 | V1.1 — DoD automatisée, iamthelaw et enforcement budget | feature | P2 | 🔴 todo | |
| 0008 | Proxy Vite cible :3000 alors que le daemon écoute :4242 | bug | P2 | 🔴 todo | |
| 0009 | Durcir les appels git worktree (execFileSync, anti-injection shell) | refactor | P2 | 🔴 todo | |
